...
window.PaginaDashboard = (function () {
  async function render(container) {
    ...
    container.innerHTML = `
      ...
      <div class="grid" style="grid-template-columns:1fr 1fr;gap:16px">
        ...
        <div class="card"><h3 style="margin-top:0">Produtos mais vendidos</h3><div id="g-ranking"></div></div>
  ...
  async function carregarResumo() {
    ...
    document.getElementById('dash-cards').innerHTML = `
      ...
      ${card('Estoque baixo', r.estoque_baixo, 'produto(s)', r.estoque_baixo > 0 ? 'var(--alerta)' : '')}
  ...
  async function carregarGraficos() {
    ...
    const [vendas, ranking, margem, abc, pagrec] = await Promise.all([
